...
static void
set_active_panel (CcTestWindow *shell, CcPanel *panel)
{
...
static gboolean
cc_test_window_set_active_panel_from_id (CcShell *shell, const gchar *start_id, GVariant *parameters, GError **error)
{
    /* Not implemented */
...
static void
cc_test_window_get_property (GObject *object, guint property_id, GValue *value, GParamSpec *pspec)
{
...
static void
cc_test_window_set_property (GObject *object, guint property_id, const GValue *value, GParamSpec *pspec)
{
...
{
    return g_object_new (CC_TYPE_TEST_WINDOW, "resizable", TRUE, "title", "Test Settings", NULL);
}
