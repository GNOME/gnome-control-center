...
static void
fixture_set_up_empty (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    ...
    fixture->panel = g_object_new (cc_network_panel_get_type (), "shell", CC_SHELL (fixture->shell), NULL);
...
static void
fixture_tear_down (NetworkPanelFixture *fixture, gconstpointer user_data)
{
...
static void
fixture_set_up_wired (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    NMDevice *second;
    ...
    fixture->main_ether =
        nmtstc_service_add_wired_device (fixture->sinfo, fixture->client, "eth1000", "52:54:00:ab:db:23", NULL);

    /* Add/remove one to catch issues with signal disconnects. */
    second = nmtstc_service_add_wired_device (fixture->sinfo, fixture->client, "eth1001", "52:54:00:ab:db:24", NULL);
...
static GtkWidget *
find_label (GtkWidget *widget, const gchar *label_pattern)
{
    GtkWidget *child;
...
static int
widget_geo_dist (GtkWidget *a, GtkWidget *b, GtkWidget *base)
{
...
static GList *
test_list_descendants (GtkWidget *widget, GType widget_type)
{
    GtkWidget *child;
    GList *results = NULL;
...
static int
widget_geo_cmp (gconstpointer a, gconstpointer b, gpointer user_data)
{
...
static GtkWidget *
find_sibling (GtkWidget *widget, GType parent_type, GType sibling_type)
{
...
static void
test_empty_ui (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    GtkWidget *bt_header;
...
static void
test_device_add (NetworkPanelFixture *fixture, gconstpointer user_data)
{
...
static void
test_second_device_add (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    NMDevice *device;
    const gchar *device_path;
    ...
    device = nmtstc_service_add_wired_device (fixture->sinfo, fixture->client, "eth1001", "52:54:00:ab:db:24", NULL);
...
static void
test_second_device_add_remove (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    NMDevice *device;
    const gchar *device_path;
    GtkWidget *bt_header;
...
static void
add_cb (GObject *object, GAsyncResult *result, gpointer user_data)
{
...
static void
test_connection_add (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    NMConnection *conn;
    g_autoptr(GError) error = NULL;
    WAIT_DECL ()
...
static void
test_unconnected_carrier_plug (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    ...
    g_assert_nonnull (find_label (GTK_WIDGET (fixture->shell), "Disabled - 1*234 Mb/s"));
}

/*****************************************************************************/

static void
test_connection_add_activate (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    NMConnection *conn;
    ...
    label = find_label (GTK_WIDGET (fixture->shell), "Disabled - 1*234 Mb/s");
...
static void
test_vpn_add (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    NMConnection *conn;
...
static void
test_vpn_add_remove (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    NMConnection *conn;
    NMSettingConnection *connsetting;
    NMSettingVpn *setting;
...
static void
test_vpn_updating (NetworkPanelFixture *fixture, gconstpointer user_data)
{
    NMConnection *conn;
    NMSettingConnection *connsetting;
    NMSettingVpn *setting;
    ...
    g_variant_builder_add (&builder, "v",
                           g_variant_new_string (nm_connection_get_connection_type (NM_CONNECTION (info.rc))));
    g_variant_builder_close (&builder);
    ...
    nmtstc_service_update_connection_variant (fixture->sinfo, nm_object_get_path (NM_OBJECT (info.rc)),
                                              g_variant_builder_end (&builder), FALSE);
...
main (int argc, char **argv)
{
    ...
    g_test_add ("/network-panel-wired/empty-ui", NetworkPanelFixture, NULL, fixture_set_up_empty, test_empty_ui,
                fixture_tear_down);

    g_test_add ("/network-panel-wired/device-add", NetworkPanelFixture, NULL, fixture_set_up_empty, test_device_add,
                fixture_tear_down);

    g_test_add ("/network-panel-wired/second-device-add", NetworkPanelFixture, NULL, fixture_set_up_empty,
                test_second_device_add, fixture_tear_down);

    g_test_add ("/network-panel-wired/second-device-add-remove", NetworkPanelFixture, NULL, fixture_set_up_empty,
                test_second_device_add_remove, fixture_tear_down);

    g_test_add ("/network-panel-wired/unconnected-carrier-plug", NetworkPanelFixture, NULL, fixture_set_up_wired,
                test_unconnected_carrier_plug, fixture_tear_down);

    g_test_add ("/network-panel-wired/connection-add", NetworkPanelFixture, NULL, fixture_set_up_wired,
                test_connection_add, fixture_tear_down);

    g_test_add ("/network-panel-wired/connection-add-activate", NetworkPanelFixture, NULL, fixture_set_up_wired,
                test_connection_add_activate, fixture_tear_down);
  ...
  g_test_add ("/network-panel-wired/connection-multi-add-activate",
    ...
    g_test_add ("/network-panel-wired/vpn-add", NetworkPanelFixture, NULL, fixture_set_up_empty, test_vpn_add,
                fixture_tear_down);

    g_test_add ("/network-panel-wired/vpn-add-remove", NetworkPanelFixture, NULL, fixture_set_up_empty,
                test_vpn_add_remove, fixture_tear_down);

    g_test_add ("/network-panel-wired/vpn-updating", NetworkPanelFixture, NULL, fixture_set_up_empty, test_vpn_updating,
                fixture_tear_down);
