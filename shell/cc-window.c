...
static gboolean
cc_window_set_active_panel_from_id (CcShell *shell, const gchar *start_id, GVariant *parameters, GError **error)
{
...
cc_window_class_init (CcWindowClass *klass)
{
    ...
    g_object_class_install_property (
        ...
        g_param_spec_object ("model", "Model", "The CcShellModel of this application", CC_TYPE_SHELL_MODEL,
                             G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY | G_PARAM_STATIC_STRINGS));

    g_object_class_install_property (object_class, PROP_COLLAPSED,
                                     g_param_spec_boolean ("collapsed", "Collapsed", "Whether the window is collapsed",
...
void
cc_window_set_search_item (CcWindow *center, const char *search)
{
