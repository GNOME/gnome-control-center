...
struct _CcFormatChooser {
        ...
        GtkWidget *popular_region_title;
        GtkWidget *popular_region_listbox;
               ...
               const gchar     *locale_id)
{
        ...
        update_check_button_for_list (chooser->popular_region_listbox, locale_id);
...
format_chooser_leaflet_fold_changed_cb (CcFormatChooser *self)
{
  ...
  gtk_container_foreach (GTK_CONTAINER (self->popular_region_listbox),
             ...
             GHashTable      *initial)
{
        ...
        for (l = initial_locales; l != NULL; l = l->next) {
                ...
                gtk_container_add (GTK_CONTAINER (chooser->popular_region_listbox), widget);
          }
...
filter_changed (CcFormatChooser *chooser)
{
        ...
        gtk_widget_set_visible (chooser->popular_region_listbox, visible);
        gtk_widget_set_visible (chooser->popular_region_title, visible);
...
cc_format_chooser_class_init (CcFormatChooserClass *klass)
{
        ...
        gtk_widget_class_bind_template_child (widget_class, CcFormatChooser, popular_region_title);
        gtk_widget_class_bind_template_child (widget_class, CcFormatChooser, popular_region_listbox);
...
cc_format_chooser_init (CcFormatChooser *chooser)
{
        ...
        gtk_list_box_set_sort_func (GTK_LIST_BOX (chooser->popular_region_listbox),
        ...
        gtk_list_box_set_header_func (GTK_LIST_BOX (chooser->popular_region_listbox),
                                      cc_list_box_update_header_func, NULL, NULL);
