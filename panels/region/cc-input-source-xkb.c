...
static gboolean
cc_input_source_xkb_matches (CcInputSource *source, CcInputSource *source2)
{
...
CcInputSourceXkb *
cc_input_source_xkb_new (GnomeXkbInfo *xkb_info, const gchar *layout, const gchar *variant)
{
...
CcInputSourceXkb *
cc_input_source_xkb_new_from_id (GnomeXkbInfo *xkb_info, const gchar *id)
{
