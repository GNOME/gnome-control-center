...
cc_input_row_init (CcInputRow *row)
{
        ...
        gtk_widget_set_margin_start (row->label, 20);
        gtk_widget_set_margin_end (row->label, 20);
        gtk_widget_set_margin_top (row->label, 18);
        gtk_widget_set_margin_bottom (row->label, 18);
        gtk_box_pack_start (GTK_BOX (box), row->label, TRUE, TRUE, 0);

        row->image = gtk_image_new ();
        gtk_widget_set_margin_start (row->image, 20);
        gtk_widget_set_margin_end (row->image, 20);
        gtk_widget_set_margin_top (row->image, 6);
        gtk_widget_set_margin_bottom (row->image, 6);
