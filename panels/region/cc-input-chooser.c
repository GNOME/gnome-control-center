...
static void
row_activated (CcInputChooser *chooser, GtkListBoxRow  *row)
{
  gpointer data;
...
cc_input_chooser_class_init (CcInputChooserClass *klass)
{
  ...
  gtk_widget_class_bind_template_callback (widget_class, list_button_release_event);
  gtk_widget_class_bind_template_callback (widget_class, filter_changed);
  gtk_widget_class_bind_template_callback (widget_class, reset_on_escape);
}
