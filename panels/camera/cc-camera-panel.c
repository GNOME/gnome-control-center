                   ...
                   GVariant *permissions_data)
{
  ...
  gtk_widget_set_visible (GTK_WIDGET (self->camera_apps_label), has_apps);
  gtk_widget_set_visible (GTK_WIDGET (self->camera_apps_list_box), has_apps);
}
  ...
  if (ret == NULL)
    {
      ...
      gtk_widget_set_visible (GTK_WIDGET (self->camera_apps_label), FALSE);
      gtk_widget_set_visible (GTK_WIDGET (self->camera_apps_list_box), FALSE);
...
cc_camera_panel_class_init (CcCameraPanelClass *klass)
{
  ...
  oclass->finalize = cc_camera_panel_finalize;
  oclass->constructed = cc_camera_panel_constructed;
  ...
  gtk_widget_class_bind_template_child (widget_class, CcCameraPanel, camera_apps_label);
