...
struct _CcMicrophonePanel
{
  ...
  GtkStack *stack;
  GtkListBox  *microphone_apps_label;
                   ...
                   GVariant *permissions_data)
{
  ...
  gtk_widget_set_visible (GTK_WIDGET (self->microphone_apps_label), has_app);
  gtk_widget_set_visible (GTK_WIDGET (self->microphone_apps_list_box), has_app);
}
  ...
  if (ret == NULL)
    {
      ...
      gtk_widget_set_visible (GTK_WIDGET (self->microphone_apps_label), FALSE);
      gtk_widget_set_visible (GTK_WIDGET (self->microphone_apps_list_box), FALSE);
...
cc_microphone_panel_class_init (CcMicrophonePanelClass *klass)
{
  ...
  oclass->finalize = cc_microphone_panel_finalize;
  oclass->constructed = cc_microphone_panel_constructed;
  ...
  gtk_widget_class_bind_template_child (widget_class, CcMicrophonePanel, microphone_apps_label);
