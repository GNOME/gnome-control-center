...
struct _CcLocationPanel
{
  ...
  GtkStack    *stack;
  GtkListBox  *location_apps_label;
                   ...
                   GVariant *permissions_data)
{
  ...
  gtk_widget_set_visible (GTK_WIDGET (self->location_apps_label), has_app);
  gtk_widget_set_visible (GTK_WIDGET (self->location_apps_list_box), has_app);
}
...
on_perm_store_lookup_done(GObject *source_object,
                          ...
                          gpointer user_data)
{
  CcLocationPanel *self = user_data;
  ...
  if (ret == NULL)
    {
      ...
      gtk_widget_set_visible (GTK_WIDGET (self->location_apps_label), FALSE);
      gtk_widget_set_visible (GTK_WIDGET (self->location_apps_list_box), FALSE);
...
cc_location_panel_class_init (CcLocationPanelClass *klass)
{
  ...
  oclass->finalize = cc_location_panel_finalize;
  oclass->constructed = cc_location_panel_constructed;
  ...
  gtk_widget_class_bind_template_child (widget_class, CcLocationPanel, location_apps_label);
