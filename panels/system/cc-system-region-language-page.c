...
#undef G_LOG_DOMAIN
#define G_LOG_DOMAIN "cc-system-region-language-page"
...
struct _CcSystemRegionLanguagePage {
...
G_DEFINE_TYPE (CcSystemRegionLanguagePage, cc_system_region_language_page, ADW_TYPE_NAVIGATION_PAGE)
...
static void
restart_now (CcSystemRegionLanguagePage *self)
{
...
static void
set_restart_notification_visible (CcSystemRegionLanguagePage *self,
                                  const gchar                *locale,
                                  gboolean                    visible)
{
        locale_t new_locale;
...
typedef struct {
        CcSystemRegionLanguagePage *self;
        int category;
        gchar *target_locale;
} MaybeNotifyData;
                     ...
                     gpointer      data)
{
        ...
        CcSystemRegionLanguagePage *self = mnd->self;
        g_autoptr(GError) error = NULL;
...
static void
maybe_notify (CcSystemRegionLanguagePage *self,
              int                         category,
...
static void
set_localed_locale (CcSystemRegionLanguagePage *self)
{
...
static void
set_system_language (CcSystemRegionLanguagePage *self,
...
static void
update_language (CcSystemRegionLanguagePage  *self,
...
static void
set_system_region (CcSystemRegionLanguagePage *self,
                   const gchar                *region)
{
...
static void
update_region (CcSystemRegionLanguagePage  *self,
               CcLocaleTarget               target,
               const gchar                 *region)
{
        switch (target) {
...
static void
language_response (CcSystemRegionLanguagePage  *self,
                   gint                         response_id,
...
static const gchar *
get_effective_language (CcSystemRegionLanguagePage  *self,
                        CcLocaleTarget               target)
{
        switch (target) {
        case USER:
...
static void
show_language_chooser (CcSystemRegionLanguagePage  *self,
                       CcLocaleTarget               target)
{
        CcLanguageChooser *chooser;
        GtkNative *native;
...
static const gchar *
get_effective_region (CcSystemRegionLanguagePage  *self,
                      CcLocaleTarget               target)
{
...
static void
format_response (CcSystemRegionLanguagePage   *self,
                 gint                          response_id,
...
static void
show_region_chooser (CcSystemRegionLanguagePage  *self,
                     CcLocaleTarget               target)
{
        CcFormatChooser *chooser;
        GtkNative *native;
...
{
        CcSystemRegionLanguagePage *self = user_data;
...
static void
update_user_region_row (CcSystemRegionLanguagePage *self)
{
...
static void
update_user_language_row (CcSystemRegionLanguagePage *self)
{
        g_autofree gchar *name = NULL;
...
static void
update_language_from_user (CcSystemRegionLanguagePage *self)
{
...
static void
update_region_from_setting (CcSystemRegionLanguagePage *self)
{
        g_free (self->region);
...
static void
setup_language_section (CcSystemRegionLanguagePage *self)
{
...
static void
update_login_region (CcSystemRegionLanguagePage *self)
{
        g_autofree gchar *name = NULL;
...
static void
update_login_language (CcSystemRegionLanguagePage *self)
{
        g_autofree gchar *name = NULL;
...
static void
set_login_button_visibility (CcSystemRegionLanguagePage *self)
{
...
localed_proxy_ready (GObject      *source,
                     ...
                     gpointer      data)
{
        CcSystemRegionLanguagePage *self = data;
        GDBusProxy *proxy;
        g_autoptr(GError) error = NULL;
...
static void
setup_login_permission (CcSystemRegionLanguagePage *self)
{
...
static void
on_login_formats_row_activated_cb (CcSystemRegionLanguagePage *self)
{
...
static void
on_login_language_row_activated_cb (CcSystemRegionLanguagePage *self)
{
        if (g_permission_get_allowed (self->permission)) {
                show_language_chooser (self, SYSTEM);
        } else if (g_permission_get_can_acquire (self->permission)) {
...
static void
on_user_formats_row_activated_cb (CcSystemRegionLanguagePage *self)
{
        show_region_chooser (self, USER);
}

static void
on_user_language_row_activated_cb (CcSystemRegionLanguagePage *self)
{
...
static void
cc_system_region_language_page_finalize (GObject *object)
{
        CcSystemRegionLanguagePage *self = CC_SYSTEM_REGION_LANGUAGE_PAGE (object);
        GtkWidget *chooser;
        ...
        G_OBJECT_CLASS (cc_system_region_language_page_parent_class)->finalize (object);
}

static void
cc_system_region_language_page_class_init (CcSystemRegionLanguagePageClass * klass)
{
        GtkWidgetClass *widget_class = GTK_WIDGET_CLASS (klass);
        GObjectClass *object_class = G_OBJECT_CLASS (klass);

        object_class->finalize = cc_system_region_language_page_finalize;

        g_type_ensure (CC_TYPE_LIST_ROW);

        gtk_widget_class_set_template_from_resource (widget_class, "/org/gnome/control-center/system/cc-system-region-language-page.ui");

        gtk_widget_class_bind_template_child (widget_class, CcSystemRegionLanguagePage, formats_row);
        gtk_widget_class_bind_template_child (widget_class, CcSystemRegionLanguagePage, banner);
        gtk_widget_class_bind_template_child (widget_class, CcSystemRegionLanguagePage, login_formats_row);
        gtk_widget_class_bind_template_child (widget_class, CcSystemRegionLanguagePage, login_group);
        gtk_widget_class_bind_template_child (widget_class, CcSystemRegionLanguagePage, login_language_row);
        gtk_widget_class_bind_template_child (widget_class, CcSystemRegionLanguagePage, language_row);
...
static void
cc_system_region_language_page_init (CcSystemRegionLanguagePage *self)
{
