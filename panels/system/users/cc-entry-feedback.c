...
cc_entry_feedback_class_init (CcEntryFeedbackClass *klass)
{
    ...
    properties[PROP_ICON_NAME] = g_param_spec_string (
        "icon-name", "Icon name", "The icon theme name for the icon to be shown", NULL, G_PARAM_READWRITE);
    properties[PROP_TEXT] = g_param_spec_string ("text", "Text", "The text to be displayed.", NULL, G_PARAM_READWRITE);
    properties[PROP_DEFAULT_ICON_NAME] =
        g_param_spec_string ("default-icon-name", "Default icon name",
                             "The icon theme name for the icon to be shown by default.", NULL, G_PARAM_READWRITE);
    properties[PROP_DEFAULT_TEXT] = g_param_spec_string (
        "default-text", "Default text", "The text to be displayed by default.", NULL, G_PARAM_READWRITE);
    properties[PROP_ENTRY] =
        g_param_spec_object ("entry", "Entry Widget", "The entry widget correspondend to this object", GTK_TYPE_WIDGET,
