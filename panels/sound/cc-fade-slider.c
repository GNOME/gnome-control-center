...
G_DEFINE_FINAL_TYPE (CcFadeSlider, cc_fade_slider, GTK_TYPE_WIDGET)
...
void
cc_fade_slider_set_channel_map (CcFadeSlider *self, GvcChannelMap *channel_map)
{
