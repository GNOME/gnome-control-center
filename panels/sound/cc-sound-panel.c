...
output_device_changed_cb (CcSoundPanel *self)
{
  ...
  cc_profile_combo_box_set_device (self->output_profile_combo_box, device);
  //FIXMEcc_balance_slider_set_device (self->balance_slider, device);
  //FIXMEcc_fade_slider_set_device (self->fade_slider, device);
  //FIXMEcc_subwoofer_slider_set_device (self->subwoofer_slider, device);
...
test_output_configuration_button_clicked_cb (CcSoundPanel *self)
{
  ...
  dialog = cc_output_test_dialog_new (cc_device_combo_box_get_device (self->output_device_combo_box));
