...
output_device_changed_cb (CcSoundPanel *self)
{
  ...
  device = cc_device_combo_box_get_device (self->output_device_combobox);
  cc_profile_combo_box_set_device (self->output_profile_combobox, device);
...
input_device_changed_cb (CcSoundPanel *self)
{
  ...
  device = cc_device_combo_box_get_device (self->input_device_combobox);
  if (device != NULL)
    stream = gvc_mixer_control_get_stream_from_device (self->mixer_control, device);
...
test_output_configuration_button_clicked_cb (CcSoundPanel *self)
{
  ...
  dialog = cc_output_test_dialog_new (cc_device_combo_box_get_device (self->output_device_combobox));
...
cc_sound_panel_class_init (CcSoundPanelClass *klass)
{
  ...
  gtk_widget_class_bind_template_child (widget_class, CcSoundPanel, output_profile_combobox);
...
cc_sound_panel_init (CcSoundPanel *self)
{
  ...
  cc_device_combo_box_set_mixer_control (self->input_device_combobox, self->mixer_control, FALSE);
  cc_device_combo_box_set_mixer_control (self->output_device_combobox, self->mixer_control, TRUE);
