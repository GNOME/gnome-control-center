...
G_DEFINE_TYPE (CcStreamRow, cc_stream_row, GTK_TYPE_BOX)
...
CcStreamRow *
cc_stream_row_new (GtkSizeGroup *size_group, GvcMixerStream *stream)
{
  CcStreamRow *self;

  self = g_object_new (cc_stream_row_get_type (), NULL);
