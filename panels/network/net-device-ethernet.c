...
static void
add_details_row (GtkWidget   *details,
                 gint         top,
                 const gchar *heading,
                 const gchar *value)
{
...
static void
show_details (NetDeviceEthernet *self,
              GtkButton         *button,
              const gchar       *title)
{
  GtkWidget *row;
...
static void
show_details_for_row (NetDeviceEthernet *self,
                      GtkButton         *button)
{
...
static void
add_row (NetDeviceEthernet *self,
         NMConnection      *connection)
{
  GtkWidget *row;
  GtkWidget *widget;
...
static void
connection_removed (NetDeviceEthernet  *self,
...
static void
connection_list_row_activated_cb (NetDeviceEthernet *self,
                                  GtkListBoxRow     *row)
{
  NMConnection *connection;
  GtkWidget *child;
...
NetDeviceEthernet *
net_device_ethernet_new (NMClient *client,
                         NMDevice *device)
{
