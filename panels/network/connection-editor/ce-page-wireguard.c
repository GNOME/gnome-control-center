...
static void
toggle_show_secret_cb (GtkEntry *entry_private_key,
                       gpointer  user_data)
{
...
static void
handle_peer_changed_cb (GtkButton     *apply_button,
...
static void
handle_peer_delete_cb (GtkButton     *delete_button,
                       WireguardPeer *wg_peer)
{
...
static void
handle_abort_new_peer (GtkPopover    *peer_popover,
                       WireguardPeer *wg_peer)
{
...
WireguardPeer *
add_nm_wg_peer_to_list (CEPageWireguard *self,
                        NMWireGuardPeer *peer)
{
  WireguardPeer *wg_peer;
...
static void
finish_setup (CEPageWireguard *self,
              gpointer         unused,
              GError          *error,
              gpointer         user_data)
{
