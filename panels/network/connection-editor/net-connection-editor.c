...
net_connection_editor_init (NetConnectionEditor *editor)
{
        ...
        gtk_list_box_set_header_func (GTK_LIST_BOX (editor->advanced_pages_container), cc_list_box_update_header_func, NULL, NULL);
        g_signal_connect (editor->advanced_pages_container, "row-activated", G_CALLBACK (advanced_page_row_activated), editor);
}
...
net_connection_editor_class_init (NetConnectionEditorClass *class)
{
        ...
        gtk_widget_class_bind_template_child (widget_class, NetConnectionEditor, pages_container);
        gtk_widget_class_bind_template_child (widget_class, NetConnectionEditor, advanced_pages);
        gtk_widget_class_bind_template_child (widget_class, NetConnectionEditor, advanced_pages_container);
...
add_advanced_page (NetConnectionEditor *editor, CEPage *page)
{
        ...
        gtk_list_box_insert (GTK_LIST_BOX (editor->advanced_pages_container), v_box, -1);
        g_object_set_data (G_OBJECT (page), "parent", parent);

        row = gtk_widget_get_parent (v_box);
        g_object_set_data (G_OBJECT (row), "revealer", revealer);

        gtk_widget_show (GTK_WIDGET (editor->advanced_pages));
...
finish_add_connection (NetConnectionEditor *editor, NMConnection *connection)
{
        ...
        gtk_stack_set_visible_child_name (editor->toplevel_stack, "details");
...
net_connection_editor_add_connection (NetConnectionEditor *editor)
{
        ...
        gtk_stack_set_visible_child_name (editor->toplevel_stack, "vpn");
