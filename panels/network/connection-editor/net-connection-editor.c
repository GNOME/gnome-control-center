...
static void
net_connection_editor_do_fallback (NetConnectionEditor *self,
                                   const gchar         *type)
{
  g_autoptr (GError) error = NULL;
...
static void
page_initialized (NetConnectionEditor *self,
                  GError              *error,
                  CEPage              *page)
{
  GtkWidget *label;
...
static void
add_page (NetConnectionEditor *self,
          CEPage              *page)
{
  gint position;
...
static void
finish_add_connection (NetConnectionEditor *self,
                       NMConnection        *connection)
{
...
static void
vpn_import_complete (NMConnection *connection,
                     gpointer      user_data)
{
  NetConnectionEditor *self = user_data;
...
static void
vpn_type_activated (NetConnectionEditor *self,
                    GtkWidget           *row)
{
...
static void
select_vpn_type (NetConnectionEditor *self,
                 GtkListBox          *list)
{
