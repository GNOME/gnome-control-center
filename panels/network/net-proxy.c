...
static void
panel_proxy_mode_radio_changed_cb (GtkRadioButton *radio,
                                   NetProxy       *proxy)
{
        ProxyMode value;
...
show_dialog_cb (GtkWidget *button,
                NetProxy  *self)
{
        gtk_window_set_transient_for (GTK_WINDOW (self->dialog), GTK_WINDOW (gtk_widget_get_toplevel (button)));
...
net_proxy_init (NetProxy *proxy)
{
        ...
        g_signal_connect (proxy->none_radio, "toggled", G_CALLBACK (panel_proxy_mode_radio_changed_cb), proxy);
        g_signal_connect (proxy->manual_radio, "toggled", G_CALLBACK (panel_proxy_mode_radio_changed_cb), proxy);
        g_signal_connect (proxy->automatic_radio, "toggled", G_CALLBACK (panel_proxy_mode_radio_changed_cb), proxy);

        /* show dialog button */
        g_signal_connect (proxy->dialog_button,
                          "clicked",
