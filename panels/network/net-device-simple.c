...
nm_device_simple_refresh_ui (NetDeviceSimple *device_simple)
{
        ...
        gtk_widget_set_visible (GTK_WIDGET (priv->button_options), state != NM_DEVICE_STATE_UNMANAGED);
}
...
net_device_simple_init (NetDeviceSimple *device_simple)
{
        ...
        priv->button_options = GTK_BUTTON (gtk_builder_get_object (priv->builder, "button_options"));
