                  ...
                  gboolean client_cert)
{
	...
	g_signal_connect_swapped (G_OBJECT (widget), "selection-changed", G_CALLBACK (changed_cb), parent);
                    ...
                    gboolean secrets_only)
{
	...
	widget = GTK_WIDGET (gtk_builder_get_object (parent->builder, "eap_tls_ca_cert_not_required_checkbox"));
	g_assert (widget);
	g_signal_connect_swapped (widget, "toggled", G_CALLBACK (ca_cert_not_required_toggled), parent);
