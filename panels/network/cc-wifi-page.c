...
static void nm_device_wifi_refresh_ui (CcWifiPage *self);
static void show_hotspot_ui (CcWifiPage *self);
static void nm_client_on_permission_change (CcWifiPage *self);
...
static void
disable_scan_timeout (CcWifiPage *self)
{
...
static void
wireless_enabled_toggled (CcWifiPage *self)
{
        gboolean enabled;
...
static NMConnection *
find_connection_for_device (CcWifiPage *self,
                            NMDevice       *device)
{
...
static gboolean
device_is_hotspot (CcWifiPage *self)
{
        NMConnection *c;
...
static GBytes *
device_get_hotspot_ssid (CcWifiPage *self,
                         NMDevice *device)
{
        NMConnection *c;
...
static void
device_get_hotspot_security_details (CcWifiPage *self,
                                     NMDevice *device,
                                     gchar **secret,
                                     gchar **security)
{
...
static void
nm_device_wifi_refresh_hotspot (CcWifiPage *self)
{
        GBytes *ssid;
...
static void
nm_device_wifi_refresh_ui (CcWifiPage *self)
{
        ...
        gtk_stack_set_visible_child (self->stack, self->wifi_page);
        if (self->scan_id == 0 &&
...
static void
device_off_switch_changed_cb (CcWifiPage *self)
{
        gboolean active;
...
static void
connect_hidden (CcWifiPage *self)
{
...
static void
wireless_try_to_connect (CcWifiPage *self,
                         GBytes *ssid,
...
static NMConnection *cc_wifi_page_get_hotspot_connection (CcWifiPage *self);

static void
update_qr_image (CcWifiPage *self)
{
  NMConnection *hotspot;

  hotspot = cc_wifi_page_get_hotspot_connection (self);
  if (hotspot)
    {
...
static void
show_hotspot_ui (CcWifiPage *self)
{
        gtk_stack_set_visible_child (self->stack, self->hotspot_page); 
...
static NMConnection *
cc_wifi_page_get_hotspot_connection (CcWifiPage *self)
{
                   ...
                   gpointer      user_data)
{
        ...
        self = user_data;
        c = cc_wifi_page_get_hotspot_connection (self);
...
static void
stop_shared_connection (CcWifiPage *self)
{
...
static void
cc_wifi_page_dispose (GObject *object)
{
        ...
        G_OBJECT_CLASS (cc_wifi_page_parent_class)->dispose (object);
}
...
really_forgotten (GObject              *source_object,
                  ...
                  gpointer              user_data)
{
        g_autoptr(CcWifiPage) self = CC_WIFI_PAGE (user_data);
        g_autoptr(GError) error = NULL;
...
really_forget (gpointer data)
{
        ...
        self = CC_WIFI_PAGE (g_object_get_data (G_OBJECT (row), "net"));
...
static void
on_saved_networks_forget_dismissed (CcWifiPage *self)
{
...
static void
on_saved_networks_forget_undo (CcWifiPage *self)
{
        g_ptr_array_set_free_func (self->saved_networks_forgotten_rows, undo_forget);
}

static void
forget_selected (CcWifiPage *self, CcWifiConnectionRow *row, CcWifiConnectionList *list)
{
...
static void
show_details_for_row (CcWifiPage *self, CcWifiConnectionRow *row, CcWifiConnectionList *list)
{
        NMConnection *connection;
        NMAccessPoint *ap;
...
static void
show_qr_code_for_row (CcWifiPage *self, CcWifiConnectionRow *row, CcWifiConnectionList *list)
{
        NMConnection *connection;
        GtkWidget *dialog;
...
static void
on_connect_hidden_network (CcWifiPage *self)
{
        connect_hidden (self);
}

static void
on_wifi_hotspot_network (CcWifiPage *self)
{
        start_hotspot (self);
}

static void
ap_activated (CcWifiPage *self, GtkListBoxRow *row)
{
...
cc_wifi_page_class_init (CcWifiPageClass *klass)
{
        ...
        object_class->dispose = cc_wifi_page_dispose;
        ...
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, wifi_headerbar_title);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, device_enable_row);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, saved_network_row);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, connect_hidden_row);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, hotspot_row);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, details_box);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, hotspot_box);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, hotspot_page);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, hotspot_name_row);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, hotspot_security_row);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, hotspot_password_row);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, listbox_box);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, stack);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, saved_networks_dialog);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, saved_networks_toast_overlay);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, saved_networks_box);
        gtk_widget_class_bind_template_child (widget_class, CcWifiPage, wifi_page);
        ...
        gtk_widget_class_bind_template_callback (widget_class, stop_shared_connection);
}
...
cc_wifi_page_init (CcWifiPage *self)
{
        ...
        gtk_css_provider_load_from_resource (provider, "/org/gnome/control-center/network/wifi-page.css");
...
static void
nm_client_on_permission_change (CcWifiPage *self) {
...
CcWifiPage *
cc_wifi_page_new (CcPanel *panel, NMClient *client, NMDevice *device)
{
        CcWifiPage *self;
        GtkListBox *listbox;
        CcWifiConnectionList *list;

        self = g_object_new (cc_wifi_page_get_type (), NULL);
        self->panel = panel;
