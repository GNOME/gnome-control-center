...
vpn_proxy_edit (NetObject *object)
{
        ...
        window = gtk_widget_get_toplevel (GTK_WIDGET (vpn->button_options));
...
net_vpn_init (NetVpn *vpn)
{
        ...
        vpn->button_options = GTK_BUTTON (gtk_builder_get_object (vpn->builder, "button_options"));
        ...
        g_signal_connect (vpn->button_options, "clicked",
