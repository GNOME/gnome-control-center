...
static void
forget_selected (NetDeviceWifi        *self,
...
static void
show_details_for_row (NetDeviceWifi        *self,
                      CcWifiConnectionRow  *row,
                      CcWifiConnectionList *list)
{
  NMConnection *connection;
...
static void
show_qr_code_for_row (NetDeviceWifi        *self,
                      CcWifiConnectionRow  *row,
                      CcWifiConnectionList *list)
{
  NMConnection *connection;
...
static void
ap_activated (NetDeviceWifi *self,
              GtkListBoxRow *row)
{
...
void
net_device_wifi_set_title (NetDeviceWifi *self,
                           const gchar   *title)
{
