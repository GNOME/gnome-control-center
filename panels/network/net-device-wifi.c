...
static void
nm_client_permission_changed (NMClient                 *client,
...
net_device_wifi_new (CcPanel *panel, NMClient *client, NMDevice *device)
{
        ...
        g_signal_connect_object (client, "permission-changed", G_CALLBACK (nm_client_permission_changed), self, G_CONNECT_SWAPPED);
        ...
        nm_client_permission_changed (client, NM_CLIENT_PERMISSION_WIFI_SHARE_OPEN, perm, self);
