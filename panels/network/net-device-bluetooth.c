...
static void
update_off_switch_from_device_state (GtkSwitch *sw, NMDeviceState state, NetDeviceBluetooth *self)
{
...
net_device_bluetooth_new (NMClient *client, NMDevice *device)
{
    ...
    g_signal_connect_object (device, "state-changed", G_CALLBACK (nm_device_bluetooth_refresh_ui), self,
                             G_CONNECT_SWAPPED);
