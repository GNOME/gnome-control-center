...
fixture_tear_down (NetworkPanelFixture *fixture,
                   gconstpointer user_data)
{
	/* XXX: Is it correct to unref panel here? */
	g_clear_object (&fixture->panel);
	gtk_widget_destroy (fixture->shell);
	fixture->shell = NULL;
	nmtstc_service_cleanup (fixture->sinfo);
	fixture->sinfo = NULL;
}
                      ...
                      gconstpointer user_data)
{
	...
	fixture->main_ether = nmtstc_service_add_wired_device (fixture->sinfo, fixture->client, "eth1000", "52:54:00:ab:db:23", NULL);
