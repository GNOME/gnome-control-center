...
G_DEFINE_FINAL_TYPE (CcUaHearingPage, cc_ua_hearing_page, ADW_TYPE_NAVIGATION_PAGE)
...
cc_ua_hearing_page_init (CcUaHearingPage *self)
{
    ...
    g_settings_bind (self->sound_settings, KEY_SOUND_OVERAMPLIFY, self->overamplification_row, "active",
                     G_SETTINGS_BIND_DEFAULT);
    g_settings_bind (self->wm_settings, KEY_VISUAL_BELL, self->visual_alerts_row, "active", G_SETTINGS_BIND_DEFAULT);
