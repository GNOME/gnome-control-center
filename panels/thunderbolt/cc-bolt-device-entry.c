...
#define RESOURCE_UI "/org/gnome/control-center/thunderbolt/device-entry.ui"
...
cc_bolt_device_entry_class_init (CcBoltDeviceEntryClass *klass)
{
  ...
  //CcEntryClass   *entry_class = CC_ENTRY_CLASS (klass);
...
cc_bolt_device_entry_new (BoltDevice *device)
{
  ...
  g_signal_connect_object (entry->device, "notify",
