...
cc_sharing_networks_class_init (CcSharingNetworksClass *klass)
{
    ...
    properties[PROP_PROXY] = g_param_spec_object ("proxy", "proxy", "proxy", GSD_TYPE_SHARING_PROXY,
                                                  G_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY);

    properties[PROP_SERVICE_NAME] = g_param_spec_string ("service-name", "service-name", "service-name", NULL,
                                                         G_PARAM_WRITABLE | G_PARAM_CONSTRUCT_ONLY);

    properties[PROP_STATUS] = g_param_spec_uint ("status", "status", "status", CC_SHARING_STATUS_UNSET,
