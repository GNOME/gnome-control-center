...
typedef enum {
    CC_REGIONAL_LANGUAGE_ROW_TYPE_REGION = 0,
    CC_REGIONAL_LANGUAGE_ROW_TYPE_LANGUAGE = 1
} CcRegionalLanguageRowType;

#define CC_REGIONAL_LANGUAGE_ROW_TYPE (CC_REGIONAL_LANGUAGE_ROW_TYPE_REGION | \
                                       CC_REGIONAL_LANGUAGE_ROW_TYPE_LANGUAGE)
