...
G_DEFINE_TYPE (CcWwanSimLockDialog, cc_wwan_sim_lock_dialog, HDY_TYPE_DIALOG)
...
static void
cc_wwan_sim_lock_dialog_finalize (GObject *object)
{
  CcWwanSimLockDialog *self = (CcWwanSimLockDialog *)object;

  g_clear_object (&self->device);

  G_OBJECT_CLASS (cc_wwan_sim_lock_dialog_parent_class)->finalize (object);
}
...
cc_wwan_sim_lock_dialog_class_init (CcWwanSimLockDialogClass *klass)
{
  ...
  object_class->finalize = cc_wwan_sim_lock_dialog_finalize;
