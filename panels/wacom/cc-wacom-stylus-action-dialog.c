...
static void
keybinding_edited (CcWacomStylusActionDialog *self, guint keyval, guint keycode, GdkModifierType state,
...
GtkWidget *
cc_wacom_stylus_action_dialog_new (GSettings *settings, const char *stylus_name, guint button, const char *key,
