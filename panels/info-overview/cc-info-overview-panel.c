  ...
  if (load_gnome_version (&gnome_version, NULL, NULL))
    {
      ...
      cc_list_row_set_secondary_label (self->version_row, gnome_version);
...
cc_info_overview_panel_class_init (CcInfoOverviewPanelClass *klass)
{
  ...
  gtk_widget_class_bind_template_child (widget_class, CcInfoOverviewPanel, main_box);
  ...
  gtk_widget_class_bind_template_child (widget_class, CcInfoOverviewPanel, version_row);
...
cc_info_overview_panel_init (CcInfoOverviewPanel *self)
{
  ...
  gtk_list_box_set_header_func (self->main_box, cc_list_box_update_header_func, NULL, NULL);
