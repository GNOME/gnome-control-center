...
struct _CcAppNotificationsDialog {
  ...
  AdwSwitchRow        *notifications_switch;
  AdwSwitchRow        *sound_alerts_switch;
  AdwSwitchRow        *notification_banners_switch;
  AdwSwitchRow        *notification_banners_content_switch;
  AdwSwitchRow        *lock_screen_notifications_switch;
  AdwSwitchRow        *lock_screen_content_switch;
};
...
static void
set_portal_permissions_for_app (CcAppNotificationsDialog *dialog,
                                AdwSwitchRow             *the_switch)
{
  gboolean allow = adw_switch_row_get_active (the_switch);
...
{
  g_settings_set_boolean (dialog->settings, "enable", 
                          adw_switch_row_get_active (dialog->notifications_switch));
...
{
  g_settings_set_boolean (dialog->settings, "enable-sound-alerts", 
                          adw_switch_row_get_active (dialog->sound_alerts_switch));
}

static void
notification_banners_switch_state_set_cb (CcAppNotificationsDialog *dialog)
{
  g_settings_set_boolean (dialog->settings, "show-banners", 
                          adw_switch_row_get_active (dialog->notification_banners_switch));
  update_banner_content_switch (dialog);
}
...
{
  g_settings_set_boolean (dialog->settings, "force-expanded", 
                          adw_switch_row_get_active (dialog->notification_banners_content_switch));
}

static void
lock_screen_notifications_switch_state_set_cb (CcAppNotificationsDialog *dialog)
{
  g_settings_set_boolean (dialog->settings, "show-in-lock-screen", 
                          adw_switch_row_get_active (dialog->lock_screen_notifications_switch));
  update_lock_screen_content_switch (dialog);
}
...
{
  g_settings_set_boolean (dialog->settings, "details-in-lock-screen", 
                          adw_switch_row_get_active (dialog->lock_screen_content_switch));
}
...
update_notification_switch (CcAppNotificationsDialog *dialog)
{
  ...
  adw_switch_row_set_active (dialog->notifications_switch, g_settings_get_boolean (dialog->settings, "enable"));
...
update_sound_switch (CcAppNotificationsDialog *dialog)
{
  ...
  adw_switch_row_set_active (dialog->sound_alerts_switch, g_settings_get_boolean (dialog->settings, "enable-sound-alerts"));
...
update_banner_switch (CcAppNotificationsDialog *dialog)
{
  ...
  adw_switch_row_set_active (dialog->notification_banners_switch, active);
...
update_banner_content_switch (CcAppNotificationsDialog *dialog)
{
  ...
  adw_switch_row_set_active (dialog->notification_banners_content_switch, active);
...
update_lock_screen_switch (CcAppNotificationsDialog *dialog)
{
  ...
  adw_switch_row_set_active (dialog->lock_screen_notifications_switch, active);
...
update_lock_screen_content_switch (CcAppNotificationsDialog *dialog)
{
  ...
  adw_switch_row_set_active (dialog->lock_screen_content_switch, active);
