...
static GIAData *
gia_data_new (const gchar  *printer_name,
              gchar       **attributes_names,
              GIACallback   callback,
              gpointer      user_data)
{
...
static PSPData *
psp_data_new (const gchar  *printer_name,
              const gchar  *ppd_copy,
              GCancellable *cancellable,
              PSPCallback   callback,
              gpointer      user_data)
{
...
static GDAData *
gda_data_new (const gchar  *printer_name,
              GCancellable *cancellable,
              GDACallback   callback,
              gpointer      user_data)
{
...
static GPNData *
gpn_data_new (const gchar  *printer_name,
              gint          count,
              GCancellable *cancellable,
              GPNCallback   callback,
              gpointer      user_data)
...
static GAPData *
gap_data_new (GCancellable *cancellable,
              GAPCallback   callback,
              gpointer      user_data)
{
  GAPData *data;
...
static PGPData *
pgp_data_new (const gchar *printer_name,
...
static GNDData *
gnd_data_new (const gchar *printer_name,
              GNDCallback  callback,
              gpointer     user_data)
{
  GNDData *data;
...
static PAOData *
pao_data_new (GCancellable *cancellable,
              PAOCallback   callback,
              gpointer      user_data)
{
  PAOData *data;
...
static GCDData *
gcd_data_new (GList        *backend_list,
              GCancellable *cancellable,
              GCDCallback   callback,
              gpointer      user_data)
{
