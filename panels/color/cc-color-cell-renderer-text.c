...
static void
cc_color_cell_renderer_text_get_property (GObject *object, guint param_id, GValue *value, GParamSpec *pspec)
{
...
static void
cc_color_cell_renderer_text_set_property (GObject *object, guint param_id, const GValue *value, GParamSpec *pspec)
{
    CcColorCellRendererText *renderer = CC_COLOR_CELL_RENDERER_TEXT (object);
...
static void
cc_color_cell_renderer_snapshot (GtkCellRenderer *cell, GtkSnapshot *snapshot, GtkWidget *widget,
                                 ...
                                 GtkCellRendererState flags)
{
    ...
    GTK_CELL_RENDERER_CLASS (parent_class)->snapshot (cell, snapshot, widget, background_area, cell_area, flags);
...
cc_color_cell_renderer_text_class_init (CcColorCellRendererTextClass *class)
{
    ...
    g_object_class_install_property (object_class, PROP_IS_DIM_LABEL,
                                     g_param_spec_boolean ("is-dim-label", NULL, NULL, FALSE, G_PARAM_READWRITE));
}
