...
static void
gcm_prefs_profile_view (CcColorPanel *self,
                        CdProfile    *profile)
{
  GtkNative *native;
  GdkSurface *surface;
...
static void
gcm_prefs_device_clicked (CcColorPanel *self,
                          CdDevice     *device)
{
...
static void
gcm_prefs_profile_clicked (CcColorPanel *self,
                           CdProfile    *profile,
                           CdDevice     *device)
{
...
static void
gcm_prefs_add_device_profiles (CcColorPanel *self,
                               CdDevice     *device)
{
  CdProfile *profile_tmp;
  g_autoptr (GPtrArray) profiles = NULL;
...
static void
gcm_prefs_device_changed_cb (CcColorPanel *self,
                             CdDevice     *device)
{
  GtkWidget *child;
  CdDevice *device_tmp;
...
static void
gcm_prefs_add_device (CcColorPanel *self,
                      CdDevice     *device)
{
  gboolean ret;
  g_autoptr (GError) error = NULL;
...
static void
gcm_prefs_remove_device (CcColorPanel *self,
                         CdDevice     *device)
{
  GtkWidget *child;
  CdDevice *device_tmp;
