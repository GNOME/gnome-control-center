      ...
      if (completed)
        {
          ...
          set_enroll_result_message (self, ENROLL_STATE_COMPLETED, _("Complete"));
  ...
  if (error)
    {
      ...
      g_warning ("%s", error_message);
      notify_error (self, error_message);
      set_enroll_result_message (self, ENROLL_STATE_ERROR, _("Failure reading Finger"));
