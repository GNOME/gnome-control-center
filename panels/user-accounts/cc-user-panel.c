...
struct _CcUserPanel {
        ...
        GtkButton       *account_fingerprint_button;
        GtkLabel        *account_fingerprint_label;
        GtkButton       *account_language_button;
        GtkLabel        *account_language_button_label;
        GtkButton       *account_password_button;
        GtkLabel        *account_password_button_label;
        GtkBox          *accounts_box;
...
show_user (ActUser *user, CcUserPanel *self)
{
        ...
        gtk_label_set_label (self->account_password_button_label, get_password_mode_text (user));
        enable = act_user_is_local_account (user);
        gtk_widget_set_sensitive (GTK_WIDGET (self->account_password_button_label), enable);
        ...
        gtk_label_set_label (self->account_language_button_label, name);
        g_free (lang);
        g_free (name);
        ...
        show = (act_user_get_uid (user) == getuid() &&
                ...
                set_fingerprint_label (self->account_fingerprint_button));
        gtk_widget_set_visible (GTK_WIDGET (self->account_fingerprint_label), show);
        gtk_widget_set_visible (GTK_WIDGET (self->account_fingerprint_button), show);
        ...
        show = act_user_get_uid (user) != getuid();
        gtk_widget_set_visible (GTK_WIDGET (self->account_language_button), show);
...
change_name_done (CcUserPanel *self)
{
        ...
        text = gtk_entry_get_text (GTK_ENTRY (self->full_name_entry));
...
change_fingerprint (CcUserPanel *self)
{
        ...
        fingerprint_button_clicked (GTK_WINDOW (gtk_widget_get_toplevel (GTK_WIDGET (self))), self->account_fingerprint_button, user);
}
                       ...
                       gpointer     data)
{
        ...
        if (is_authorized || self_selected) {
                ...
                gtk_widget_set_sensitive (GTK_WIDGET (self->account_language_button), TRUE);
                remove_unlock_tooltip (GTK_WIDGET (self->account_language_button));

                gtk_widget_set_sensitive (GTK_WIDGET (self->account_password_button), TRUE);
                remove_unlock_tooltip (GTK_WIDGET (self->account_password_button));

                gtk_widget_set_sensitive (GTK_WIDGET (self->account_fingerprint_button), TRUE);
                remove_unlock_tooltip (GTK_WIDGET (self->account_fingerprint_button));
                ...
                gtk_widget_set_sensitive (GTK_WIDGET (self->account_language_button), FALSE);
                add_unlock_tooltip (GTK_WIDGET (self->account_language_button));

                gtk_widget_set_sensitive (GTK_WIDGET (self->account_password_button), FALSE);
                add_unlock_tooltip (GTK_WIDGET (self->account_password_button));

                gtk_widget_set_sensitive (GTK_WIDGET (self->account_fingerprint_button), FALSE);
                add_unlock_tooltip (GTK_WIDGET (self->account_fingerprint_button));
...
cc_user_panel_class_init (CcUserPanelClass *klass)
{
        ...
        gtk_widget_class_bind_template_child (widget_class, CcUserPanel, account_fingerprint_button);
        gtk_widget_class_bind_template_child (widget_class, CcUserPanel, account_fingerprint_label);
        gtk_widget_class_bind_template_child (widget_class, CcUserPanel, account_language_button);
        gtk_widget_class_bind_template_child (widget_class, CcUserPanel, account_language_button_label);
        gtk_widget_class_bind_template_child (widget_class, CcUserPanel, account_password_button);
        gtk_widget_class_bind_template_child (widget_class, CcUserPanel, account_password_button_label);
