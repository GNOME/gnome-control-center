...
static void change_name_done (CcUserPanel *self);
...
show_user (ActUser *user, CcUserPanel *self)
{
        ...
        g_signal_handlers_block_by_func (self->full_name_edit_button, change_name_done, self);
        ...
        g_signal_handlers_unblock_by_func (self->full_name_edit_button, change_name_done, self);
